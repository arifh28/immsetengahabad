...
<header class="masthead">
    ...
    <section id="atas">
        <div class="profil">
            <h4>Assalamualaikum <?php echo $nama;?> | <a href="login/logout">Keluar</a> </h4>
        </div>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
                    <li class="active"><a href="#tentang">Home</a>
                    </li>
                    <li><a href="#tanfidz">tanfidz</a>
                    </li>
                    <li><a href="#artikel">Artikel</a>
                    </li>
                    <li><a href="#perkaderan">Perkaderan</a>
                    </li>
                </ul>
            </div>
            <!-- /.navbar-collapse -->
...
<section id="news">
    <div class="container">
        <div class="row">
            <h1 id="artikel">Artikel dan Berita</h1>
            <hr>
            ...
            <div class="col-md-12">
                ...
                <div class="col-md-4">
                    ...
                    <div class="card radius shadowDepth1 scrollpoint sp-effect2">
                        <div class="card__image border-tlr-radius">
                            <a title="<?=$b['title']?>" href="<?php echo base_url(); ?>content/<?=$b['category']?>/<?=$b['slug']?>">
                                <img title="<?=$b['title']?>" src="<?php echo base_url(); ?>file/blog/<?=$b['img_header']?>" alt="<?=$b['title']?>">
                            </a>
                        </div>

                        <div class="card__content card__padding">
                            <div class="card__share">
                                <a class="share-toggle share-icon" href="<?php echo base_url(); ?>content/<?=$b['category']?>/<?=$b['slug']?>"></a>
                            </div>
                            ...
                            <article class="card__article">
                                <h3><?=character_limiter($b['title'],30) ?></h3>
                                <hr>
                                <p><?=character_limiter($b['content'],400) ?></p>
                            </article>
                        </div>
                ...
                <hr>
                <h1 id="perkaderan">Perkaderan</h1>

                <div class="row">

                    <?php foreach ($perkaderan as $p): ?>
                        <div class="col-md-4">

                            <div class="card radius shadowDepth1  scrollpoint sp-effect2">
                                <div class="card__image border-tlr-radius">
                                    <a title="<?=$p['nama']?>" href="<?php echo base_url(); ?>perkaderan/<?=$p['category']?>/<?=$p['slug']?>">
                                        <img title="<?=$p['nama']?>" src="<?php echo base_url(); ?>file/dosen/<?=$p['foto']?>" alt="<?=$p['nama']?>">
                                    </a>
                                </div>

                                <div class="card__content card__padding">
                                    <div class="card__share">
                                        <a class="share-toggle share-icon" href="<?php echo base_url(); ?>perkaderan/<?=$p['category']?>/<?=$p['slug']?>"></a>
                                    </div>

                                    <div class="card__meta">
                                        <?=$p['category']?>, <?=$p['penyelenggara']?>
                                        <p><?=$p['tanggal']?></p>
                                    </div>

                                    <article class="card__article">
                                        <h3><?=character_limiter($p['nama'],30) ?></h3>
                                        <hr>
                                        <p><?=character_limiter($p['isi'],150) ?></p>
                                    </article>
                                </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <a href="<?php echo base_url();?>pages/perkaderan" class="btn btn-primary btn-lg">PERKADERAN LAIN</a>
                    </div> <!-- /.col-md-12 -->
                </div> <!-- /.row -->
            </div> <!-- /.col-md-8 -->
        </div>
