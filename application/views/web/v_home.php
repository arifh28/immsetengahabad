        ...
        <div id="immersive_slider">
            ...
            <div class="slide" data-blurred="<?php echo base_url();?>assets/web/images/slide2_blurred.jpg">
                <div class="content">
                    ...
                    <p>It’s never been easier to watch YouTube on the big screen
                        Send your favorite YouTube videos from your Android phone or tablet to TV with the touch of a button. It’s easy. No wires, no setup, no nothing. Find out more here.</p>
                    <a href="<?php echo base_url();?>info_imm" class="btn btn-lg btn-danger">Info IMM</a>
                </div>
                <div class="image">
...
<section id="login">
    <div class="alert alert-danger fade in">
        ...
        <div class="container">
            <div class="col-md-12">
                <h2>Assalamualaikum <?php echo $nama;?></h2>
                <hr>
            </div>
            <div class="row">
                <div class="col-md-8">
                    ...
                    <a href="login/logout" class="btn btn-login btn-primary">Keluar</a>
                </div>
                <div class="col-md-4">
...
<section id="imm">
    <div class="container">
        ...
        <div class="list religi">
            <div class="media media-circle">
                <img src="<?php echo base_url();?>assets/web/images/4.jpg" alt="" class="pull-left">
                <div class="media-body">
